...
const s = 3600;
const hours1 = prompt("Введіть кількість годин: ");

if (!isNaN(hours1)){
  const product = hours1 * s;

  alert(
    `Кількість секунд у ${hours1} годинах: ${product} ${'sec'}`
  );
}
else {
  alert("Ви ввели неправильні числа. Будь ласка, введіть кількість годин.");
};
